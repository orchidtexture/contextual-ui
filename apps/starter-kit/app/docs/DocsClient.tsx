  ...
  const initialFooter = {
    ...
    columns: [
      ...
      },
      {
        ...
        title: 'Ecosystem',
        links: [
          { id: 'c4', label: 'GitHub Repository', href: 'https://github.com/orchidtexture/contextual-ui', external: true },
          { id: 'c5', label: 'Static Connector', href: 'https://github.com/orchidtexture/contextual-ui', external: true },
          { id: 'c6', label: 'Dashboard CMS', href: 'https://github.com/orchidtexture/contextual-ui', external: true },
        ],
      },
    ],
...
export default async function DocsPage() {
  ...
  return (
    <div className="pt-24 pb-28 max-w-7xl mx-auto px-6">
      <div className="mb-10 pb-8 border-b border-base flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-3 max-w-3xl">
          <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-md text-xs font-mono text-accent bg-accent/10 border border-accent/20">
            <span>●</span>
            <span>Contextual UI Documentation</span>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-3 shrink-0">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-4 py-2.5 rounded-xl bg-zinc-100 text-zinc-950 hover:bg-white font-semibold text-xs font-mono transition-all flex items-center gap-2 shadow-sm hover:scale-[1.02] active:scale-[0.98]"
          >
            <svg
              viewBox="0 0 24 24"
              width="16"
          ...
          <a
            ...
            className="px-4 py-2.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 text-zinc-200 border border-base font-medium text-xs transition-colors flex items-center gap-1.5"
          >
