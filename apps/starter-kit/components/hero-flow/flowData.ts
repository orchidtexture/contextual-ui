...
export const initialNodes: Node<FlowNodeData>[] = [
  {
    ...
    data: {
      ...
      tags: ['staticConnector()', 'CMS / DB', 'REST / GraphQL'],
...
export const connector = staticConnector({
  ...
  },
  {
    ...
    data: {
      ...
      tags: ['defineSchema()', 'faqRegistry()', 'z.infer<T>'],
...
export type SiteData = InferData<typeof siteSchema>;`,
  ...
  },
  {
    ...
    data: {
      ...
      tags: ['createContextualApp', 'buildGraph()', 'Multi-channel'],
...
const graph = await siteApp.generateGraph();`,
  ...
  },
  {
    ...
    data: {
      ...
      tags: ['Radix UI', 'asChild', 'Tailwind CSS'],
  ...
  },
  {
    ...
    data: {
      ...
      tags: ['JSON-LD', 'Canonical @id', '/api/graph.json'],
  ...
  },
  {
    ...
    data: {
      ...
      tags: ['Zero Scraping', 'RAG Context', 'Token Optimized'],
